// const s = `=?UTF-8?B?5Zue5aSNOiBjZW50cmFsIGh1Yue9keermeabtOaUuQ==?=`;
...
class Decoder {
   ...
   * 
   **/
  // foldLine(str, maxLength, foldAnywhere, afterSpace) {
  ...
  * 
  **/
  // encodeMimeWord(str, encoding, charset) {
  ...
  **/
  // encodeQuotedPrintable(str, mimeWord, charset) {
  //   charset = charset || "UTF-8";
  ...
  **/
  // encodeBase64 = function (str, charset) {
  //   var buffer;
  ...
  **/
  decodeBase64 = function (str, charset) {
